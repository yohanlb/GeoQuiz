  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300',
  {
    variants: {
      variant: {
        ...
        success:
          'bg-green-500 text-gray-50 shadow hover:bg-green-500/90 dark:bg-green-600 dark:text-gray-900 dark:hover:bg-green-600/90',
        accent:
          'bg-accent text-gray-900 shadow-sm hover::bg-accent-light dark:bg-accent dark:text-gray-900 dark:hover:bg-accent-light',
        destructive:
          'bg-red-500 text-gray-50 shadow-sm hover:bg-red-500/90 dark:bg-red-700 dark:text-gray-50 dark:hover:bg-red-700/90',
        outline:
